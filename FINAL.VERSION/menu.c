...
void muestraMenu()
{
    ...
    color(9);
    replicaChar('-',40);
    printf("SALA 8, TODOS LOS DERECHOS RESERVADOS.");
    replicaChar('-',40);
    printf("\n");
    replicaChar('<',50);
    printf (" MENU GENERAL ");replicaChar('>',55);
    color(9);
    printf("\n");
    printf("\n\t\t\t\t\t\t0    - MENU CLIENTES.");
    printf("\n\t\t\t\t\t\t1    - MENU CONSUMOS.\n");
...
int MenuCliente ()
{
    ...
    printf("\n\t\t\t\t\t4    - BUSCAR UN CLIENTE POR NR CLIENTE.");
    printf("\n\t\t\t\t\t5    - MOSTRAR CLIENTES ACTIVOS.");
    printf("\n\t\t\t\t\t6    - MOSTRAR CLIENTES INACTIVOS.");
    printf("\n\t\t\t\t\t7    - MODIFICAR DATO DE CLIENTES.");
    printf("\n\t\t\t\t\t       INGRESE UNA OPCION.\n");
    printf("\n");
    color(9);
...
int MenuConsumo()
{
    ...
    color(9);
    printf("\n");
    printf("\n\t\t\t\t\t0    - CARGAR ARCHIVO DE CONSUMO RANDOM.");
    printf("\n\t\t\t\t\t1    - CARGAR ARCHIVO DE CONSUMO MANUAL.");
    printf("\n\t\t\t\t\t2    - MOSTRAR ARCHIVO DE CONSUMO.");
