...
{/** \brief Esta función registra un consumo manual en un archivo imputándolo a un cliente en una fecha determinada.
     *
...
{/** \brief Esta funcion devuelve el id del cliente en la última posición del archivo.
     *
     * \param el archivo donde se guardan los clientes.
     * \return el último id del cliente.
     *
     */
...
{/** \brief Esta funcion devuelve el id del consumo en la última posición del archivo.
 *
 * \param Se pasa el archivo de consumos.
 * \return La última posición del id del consumo.
 *
 */
    int id = 0;
    stConsumos c;
...
{/** \brief Esta función verifica si el dato ingresado existe o no en el archivo de clientes.
     *
     * \param Se pasa la dirección de memoria del archivo a consultar.
...
{/** \brief Esta función cambia el estado (activo/inactivo) de un cliente en el archivo.
 *
 * \param recibe archivo donde se encuentra cargado el nro del cliente.
 * \param recibe el número del cliente que se quiere modificar el estado.
 * \return No devuelve nada.
 *
 */
...
{/** \brief Imprime por pantalla los datos de un cliente.
     ...
     * \param Recibe el número de cliente a mostrar.
     * \return No devuelve nada.
     *
     */
...
{/** \brief Esta función muestra por pantalla un listado de todos los clientes activos.
     *
     * \param Recibe el archivo de clientes.
     * \return No retorna nada.
     *
...
{/** \brief Esta función cambia el nombre y apellido de un cliente.
     *
     * \param Recibe el archivo de clientes.
     * \param Recibe el número del cliente a modificar.
     * \return No devuelve nada.
     *
     */
...
{/** \brief Cambia el número de teléfono de un cliente.
     *
     * \param Recibe el archivo de clientes.
     * \param Recibe el número de cliente a modificar.
     * \return No retorna nada.
     *
     */
...
{/** \brief Esta función cambia el domicilio de un cliente.
     *
     * \param Archivo de clientes.
     * \param número del cliente a modificar.
     * \return No retorna nada.
     *
     */
...
{/** \brief Esta función cambia el estado (baja/alta) de un consumo.
     *
...
{/** \brief Esta función imprime por pantalla todos los consumos de una fecha.
     *
...
void mostrarClientePorApellido(char nombreArchivo[],char apellido[])
{/** \brief Imprime por pantalla los datos de un cliente por apellido.
     *
     * \param Recibe el archivo de clientes.
     * \param Recibe apellido del cliente a mostrar.
     * \return No devuelve nada.
     *
     */
    ...
    if(archi)
    {
        while(fread(&e, sizeof(stCliente), 1, archi)>0)
        {
        ...
        if (existe==0)
            printf("\n\t\t\t\t\tEL APELLIDO INGRESADO NO EXISTE EN NUESTRA BASE DE DATOS.\n");
        system("pause");
        fclose(archi);
    }
}

void mostrarClientePorDni(char nombreArchivo[],char dni[])
{/** \brief Imprime por pantalla los datos de un cliente por dni.
     *
     * \param Recibe el archivo de clientes.
     * \param Recibe el dni del cliente a mostrar.
     * \return No devuelve nada.
     *
     */
